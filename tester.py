...
class Tester:
    ...
    def run_test(self, test_name):
        tests = {
            ...
            "smb_null_session": self.smb_null,      # FIX: was pointing to smb_null_session which didn't exist
    ...
    def http_title(self):
        try:
            ...
            if "<title>" in r.text.lower():
                ...
                end   = r.text.lower().find("</title>")   # FIX: was finding <title> again instead of </title>
    ...
    def ftp_anonymous(self):
        try:
            ...
            files = ftp.nlst()
            ftp.quit()
            return f"[FTP] Anonymous login allowed. Files: {files}"
        except Exception as e:
